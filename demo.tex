...
The \texttt{accmath} environment provides display math with alt text for accessibility. \\
  
\begin{accmath}[Sample standard deviation]
  s = \sqrt{\frac{\displaystyle\sum_{i=1}^{n} x_i^2 - \frac{1}{n} \left(\sum_{i=1}^{n} x_i\right)^2}{n - 1}}
\end{accmath}

\ \\ \ \\
The \texttt{acceqn} environment is a numbered equation with alt text: 

\begin{acceqn}[Euler's Identity]
  e^{i\pi} + 1 = 0 
\end{acceqn}

\section{Lists}

\begin{itemize}[leftmargin=3pc]
  \item This is an item in a bulleted list.
  \item Use the \texttt{leftmargin} option to adjust the indentation of list items as needed.
  \item Lists are tagged properly for accessibility.
\end{itemize}

\begin{enumerate}
  \item This is an item in a numbered list.
  \item Numbered lists are also tagged properly for accessibility.
\end{enumerate}
